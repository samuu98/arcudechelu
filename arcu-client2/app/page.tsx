...
export default function Home() {
  // ... (Tutto il codice degli stati e delle immagini rimane invariato fino al return)
      ...
      <header className="fixed w-full bg-white/80 backdrop-blur-sm z-50 shadow-sm transition-all duration-300">
        ...
        <div className="container mx-auto flex items-center justify-between py-3 md:py-4 px-4">
          <div className="text-2xl font-semibold text-bnb-700">
            <Link href="/" className="flex items-center">
              ...
              <span className="text-sm ml-2 text-natural-600 font-normal hidden sm:inline-block"><i>Guest House</i></span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-3">
            {/* Ho rimosso il pulsante Menu rotto su mobile */}
            ...
            <a href="https://bookonline.pro/it/properties/101334?unidades=1&filter_zone=1&referencia_propietario=Prenotazione%2520da%2520sito" target="_blank" rel="noopener noreferrer">
              <Button variant="bnb" className="flex">{t('nav.bookNow', 'Prenota Ora')}</Button>
            </a>
          </div>
        </div>

        {/* Header Secondo Livello (SOLO MOBILE) */}
        {/* Questo sostituisce il pulsante menu con una barra di navigazione orizzontale scorrevole */}
        <div className="md:hidden w-full border-t border-natural-100 bg-white/95 backdrop-blur-sm overflow-x-auto scrollbar-hide">
          <nav className="flex items-center px-4 py-3 gap-6 min-w-max mx-auto">
            <Link href="#about" className="text-sm font-medium text-natural-600 whitespace-nowrap active:text-bnb-600">
              {t('nav.about', 'Chi Siamo')}
            </Link>
            <Link href="#rooms" className="text-sm font-medium text-natural-600 whitespace-nowrap active:text-bnb-600">
              {t('nav.rooms', 'Camere')}
            </Link>
            <Link href="#services" className="text-sm font-medium text-natural-600 whitespace-nowrap active:text-bnb-600">
              {t('nav.services', 'Servizi')}
            </Link>
            <Link href="#gallery" className="text-sm font-medium text-natural-600 whitespace-nowrap active:text-bnb-600">
              {t('nav.gallery', 'Galleria')}
            </Link>
            <Link href="#contact" className="text-sm font-medium text-natural-600 whitespace-nowrap active:text-bnb-600">
